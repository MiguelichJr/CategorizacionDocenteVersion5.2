						...
						<tbody>
							<c:forEach items="${lista}" var="as">
								...
								<tr>
									...
									<td>${as.tipo}</td>	
									<td>${as.valor_maximo}</td>	
								<td class="center-align"><a href="updatesec/${as.idsc}"><i class="material-icons prefix">create</i></a><a href="#" onclick="eliminarDocente(${as.idsc})"><i class="material-icons prefix">clear</i></a></td>    
								</tr>
							</c:forEach>
						</tbody>
					</table>
