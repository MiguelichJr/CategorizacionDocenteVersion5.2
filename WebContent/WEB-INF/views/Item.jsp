					...
					<table class="">
						...
						<tbody>
							<c:forEach items="${lista}" var="as">
								...
								<td class="center-align"><a href="updatepreguntas/${as.idpreguntas}"><i class="material-icons prefix">create</i></a><a href="#"><i class="material-icons prefix">clear</i></a></td>     
								</tr>
							</c:forEach>
						</tbody>
					</table>
