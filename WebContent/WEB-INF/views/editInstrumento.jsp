				...
				<section class="container">
					<div class="row">
						...
						<article class="col s8">
							<form:form method="POST" action="/CategorizacionDocente/editarSumill/GuardarEditarInstrumento">
								<h3 class="center-align">SUMILLA</h3>
								<div class="input-field">
									<i class="material-icons prefix">perm_identity</i>
									<label for="nombre_plantilla">Nombre Sumilla</label>
									<form:input type="text" name="nombre_plantilla" path="nombre_plantilla"   />
								</div>
								<div class="input-field">
									<i class="material-icons prefix">perm_identity</i>
								...
								<form:input type="hidden" name="idinstrumento"  path="idinstrumento"/>
								...
								<p class="col s6">
									<button class="waves-effect waves-light btn" style="font-size: 10px" type="submit"><i class="material-icons right">send</i>enviar</button>
								</p>	
								</div>
