...
//		alert("si funciona el script de autoevaluacion solo dentro");  
//	});  
//      
//var numeric = "[1-5]"; 
...
//	                                                                 
////	 var resultado = resultado;        
//	 alert(resultado+"si carga el resutadi");                             
//	$("#Resultado").val(resultado);  
//});   
...
$("#Agregar2").click(function(){       
	alert("boton en acccion en agregar2");
